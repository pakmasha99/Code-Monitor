...
class WeeklySubmissionCreate(BaseModel):
    ...
    document_lines_added: int = Field(default=0, ge=0, description="Lines from documents (PDFs, text files, etc.)")
    documents_created: int = Field(default=0, ge=0, description="Number of documents created (deprecated)")
...
class WeeklySubmissionUpdate(BaseModel):
    ...
    document_lines_added: Optional[int] = Field(None, ge=0)
